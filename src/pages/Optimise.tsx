...
import { Sparkles, RefreshCw, CheckCircle2, AlertCircle, Calendar, Clock, Lock, Unlock } from 'lucide-react';
...
const Optimise = () => {
  ...
  const runOptimisation = async () => {
    ...
    try {
      ...
      // Fetch the synced events to build the report
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-500 max-w-xl mx-auto">
            Verify your calendar sync before proceeding with AI redistribution.
          </p>
        </div>
            ...
            <div className="bg-green-50 border border-green-100 p-6 rounded-3xl flex items-start gap-4">
              ...
              <div>
                ...
                <ul className="text-sm text-green-700 mt-2 space-y-1 list-disc list-inside">
                  <li>Duplicates detected: 0 (Upsert logic verified)</li>
