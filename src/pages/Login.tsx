          ...
          <div className="space-y-6">
            ...
            >
              <svg className="w-6 h-6 group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
                ...
                />
                <path
                  d="M5.84 14.09c-0.22 -0.66 -0.35 -1.36 -0.35 -2.09s0.13 -1.43 0.35 -2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s0.43 3.45 1.18 4.93l2.85 -2.22 0.81 -0.62z"
                  fill="#FBBC05"
                />
                <path
                  d="M12 5.38c1.62 0 3.06 0.56 4.21 1.64l3.15 -3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.47 2.18 7.07 3.66 2.84 8.87 2.6 3.3 4.53 12 4.53z"
                  fill="#EA4335"
                />
              </svg>
