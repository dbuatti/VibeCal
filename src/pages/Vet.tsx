    ...
    return (
      <div className="w-8 h-8 rounded-full bg-white shadow-sm border border-gray-100 flex items-center justify-center overflow-hidden shrink-0">
        <svg viewBox="0 0 24 24" className="w-4 h-4">
          ...
          <path d="M12 5.38c1.62 0 3.06 0.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.47 2.18 7.07 3.66 2.84 8.87 2.6 3.3 4.53 12 4.53z" fill="#EA4335"/>
        </svg>
      </div>
    );
  }
    ...
    return (
      <div className="w-8 h-8 rounded-full bg-white shadow-sm border border-gray-100 flex items-center justify-center overflow-hidden shrink-0">
        <svg viewBox="0 0 24 24" className="w-4 h-4 text-gray-900" fill="currentColor">
          <path d="M17.05 20.28c-0.98 0.95-2.05 1.61-3.22 1.61-1.14 0-1.55-0.67-2.85-0.67-1.32 0-1.77 0.65-2.85 0.67-1.15 0.02-2.19-0.62-3.22-1.61C2.79 18.21 1.35 14.15 1.35 10.83c0-3.32 2.12-5.07 4.16-5.07 1.08 0 1.88.43 2.54.43.64 0 1.52-0.47 2.75-0.47 1.05 0 2.02.35 2.72.95 2.02 1.73 1.85 4.45 1.85 4.45s-2.35.85-2.35 3.5c0 2.65 2.35 3.5 2.35 3.5-0.05 0.15-0.32 0.65-0.72 1.14zM12.03 4.95c-0.02-1.3 0.5-2.55 1.35-3.45.85-0.9 2.1-1.5 3.35-1.5.05 1.3-0.45 2.55-1.35 3.45-0.9 0.9-2.1 1.5-3.35 1.5z"/>
        </svg>
      </div>
    );
  }
